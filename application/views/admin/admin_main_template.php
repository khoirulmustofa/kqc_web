...
<!-- Bootstrap 3.3.7 -->
<link rel="stylesheet"
	href="<?php echo site_url('template/adminlte')?>/bower_components/bootstrap/dist/css/bootstrap.min.css">
<!-- Font Awesome -->
<link rel="stylesheet"
	href="<?php echo site_url('template/adminlte')?>/bower_components/font-awesome/css/font-awesome.min.css">
<!-- Ionicons -->
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="<?php echo site_url('template/adminlte')?>/dist/css/skins/_all-skins.min.css">
...
<body class="hold-transition skin-blue sidebar-mini fixed">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="<?php echo site_url('template/adminlte')?>/index2.html"
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img
														src="<?php echo site_url('template/adminlte')?>/dist/img/user2-160x160.jpg"
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i> <span>Dashboard</span>
						...
						<ul class="treeview-menu">
							<li><a
								href="<?php echo site_url('template/adminlte')?>/index.html"><i
									class="fa fa-circle-o"></i> Dashboard v1</a></li>
							<li><a
								href="<?php echo site_url('template/adminlte')?>/index2.html"><i
					...
					<li class="treeview"><a href="#"> <i class="fa fa-pie-chart"></i> <span>Charts</span>
						...
						<ul class="treeview-menu">
							...
							<li><a href="../charts/flot.html"><i class="fa fa-circle-o"></i>
									Flot</a></li>
							<li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i>
									Inline charts</a></li>
						</ul></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-edit"></i> <span>Forms</span>
						...
						<ul class="treeview-menu">
							<li><a href="../forms/general.html"><i class="fa fa-circle-o"></i>
									General Elements</a></li>
							<li><a href="../forms/advanced.html"><i class="fa fa-circle-o"></i>
									Advanced Elements</a></li>
							<li><a href="../forms/editors.html"><i class="fa fa-circle-o"></i>
									Editors</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-table"></i> <span>Tables</span>
						...
						<ul class="treeview-menu">
							<li><a href="../tables/simple.html"><i class="fa fa-circle-o"></i>
									Simple tables</a></li>
					...
					<li><a href="../mailbox/mailbox.html"> <i class="fa fa-envelope"></i>
					...
					<li class="treeview active"><a href="#"> <i class="fa fa-folder"></i>
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="blank.html"><i class="fa fa-circle-o"></i>
									Blank Page</a></li>
  ...
  <!-- /.content-wrapper -->
	...
	<!-- jQuery 3 -->
	<script
		src="<?php echo site_url('template/adminlte')?>/bower_components/jquery/dist/jquery.min.js"></script>
	<!-- Bootstrap 3.3.7 -->
	<script
	...
	<!-- FastClick -->
	<script
		src="<?php echo site_url('template/adminlte')?>/bower_components/fastclick/lib/fastclick.js"></script>
	<!-- AdminLTE App -->
	<script
		src="<?php echo site_url('template/adminlte')?>/dist/js/adminlte.min.js"></script>
	<!-- AdminLTE for demo purposes -->
	<script
		src="<?php echo site_url('template/adminlte')?>/dist/js/demo.js"></script>
	<!-- CK Editor -->
	<script
		src="<?php echo site_url('template/adminlte')?>/bower_components/ckeditor/ckeditor.js"></script>
