    ...
    echo form_open_multipart($action, $attributes)?>				
				<div class="box-body">
							<div class="form-group">
								<label for="varchar">Artikel Judul <?php echo form_error('artikel_judul') ?></label>
							...
							<div class="form-group">
								<label for="varchar">Artikel Judul Seo <?php echo form_error('artikel_judul_seo') ?></label>
								<input type="text" class="form-control" name="artikel_judul_seo"
									id="artikel_judul_seo" placeholder="Artikel Judul Seo"
									value="<?php echo $artikel_judul_seo; ?>" />
							</div>
							<div class="form-group">
