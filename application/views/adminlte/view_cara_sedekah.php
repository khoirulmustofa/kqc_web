<div class="container">
	<section class="content-header">
		<h1>
			<i class="fa fa-fw fa-graduation-cap"></i> PROGRAM
		</h1>
		<ol class="breadcrumb">
				...
				<div class="box-body">
					<div class="col-md-6 hover-black">
						<ul class="timeline">
							...
							<li><i class="fa fa-fw fa-arrow-down bg-green"></i>
								<div class="timeline-item">
									<div class="timeline-body">Nanti akan ada informasi transfer
										yang terdiri dari rekening anda, rekening tujuan, nama
										pemilik rekening tujuan serta jumlah uang yang di trasnfer.
										Pijit saja tombol <strong>YA</strong>, jika informasi tersebut sudah benar
										dan tunggu sampai prosesnya selesai.</div>
								</div></li>
					...
					<div class="col-md-6">
						<ul class="timeline">
							<li class="time-label"><span class="bg-green">Lewat ATM BRI ke Bank Lain </span></li>
